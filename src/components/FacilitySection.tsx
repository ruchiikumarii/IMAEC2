...
export default function FacilitySection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-r from-white to-[#f4fbf4] text-[#0f1f3d] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <button className="group flex items-center justify-center bg-[#16a34a] hover:bg-[#15803d] text-white px-8 py-3.5 rounded-2xl font-medium transition-all duration-300 shadow-[0_8px_20px_rgba(22,163,74,0.18)] hover:scale-[1.03]">
          ...
          <div className="lg:w-1/2 grid sm:grid-cols-2 gap-6">
            {facilities.map((fac, index) => (
              <motion.div
                ...
                className="bg-white rounded-[20px] p-8 flex flex-col justify-center min-h-[200px] group border border-gray-100 shadow-sm hover:border-green-300 hover:-translate-y-[6px] hover:shadow-lg transition-all duration-300 ease-in-out"
              >
                <div className="mb-6 w-14 h-14 flex items-center justify-center bg-[#eaf5ed] rounded-full transition-all duration-300 group-hover:bg-[#16a34a]">
