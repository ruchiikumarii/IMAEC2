...
export default function CTASection() {
  return (
    <section className="py-24 bg-[#fbfdfb] text-[#0f1f3d] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <button className="group inline-flex items-center justify-center bg-[#16a34a] hover:bg-[#15803d] text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all duration-300 shadow-[0_8px_22px_rgba(22,163,74,0.2)] hover:scale-[1.03]">
